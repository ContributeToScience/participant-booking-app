        ...
        if (e) {
            this.each(function () {
                ...
                function f() {
                    ...
                    c("span.plupload_upload_status", i).html(a("Uploaded %d/%d files").replace(/%d\/%d/, j.total.uploaded + "/" + j.files.length))
                }
                ...
                function g() {
                    ...
                    if (j.total.queued === 0) {
                        c("span.plupload_add_text", i).html(a("Add files."))
                    } else {
                        c("span.plupload_add_text", i).html(j.total.queued + " files queued.")
                    }
                ...
                j.bind("Init", function (l, m) {
                    ...
                    if (!e.unique_names && e.rename) {
                        i.on("click", "#" + k + "_filelist div.plupload_file_name span", function (s) {
                            ...
                            q.next().val(n).focus().blur(function () {
                                ...
                                var t = c(this);
                                if (c.inArray(u.keyCode, [13, 27]) !== -1) {
                                    u.preventDefault();
                                    if (u.keyCode === 13) {
                                        o.name = t.val() + p;
                                        q.html(o.name)
                ...
                j.bind("StateChanged", function () {
                    if (j.state === plupload.STARTED) {
                        ...
                        c("span.plupload_upload_status", i).html("Uploaded " + j.total.uploaded + "/" + j.files.length + " files");
