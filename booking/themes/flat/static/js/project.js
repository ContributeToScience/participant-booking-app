$("#error_list li").each(function () {
    ...
    var error = $(this).html();
    $("#" + fid).closest("div.control-group").addClass("error");
    $("#" + fid).closest("div.controls").append("<p class='help-block'>" + error + "</p>");
});
...
function initializeMap(map_tid, address_tid, lng_tid, lat_tid, marker_name) {
...
function initSearch() {
    ...
    search.placeholder="Enter your address"
...
$(document).on("keyup", "input[data-positive-integer-required='true']", function(){
    var value = $(this).val();
    $(this).val(value.replace(/[^\d]/g,''));
});

$(document).on("paste", "input[data-positive-integer-required='true']", function(){
    clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))
});

$(document).on("keyup", "input[data-positive-float-required='true']", function(){
    var value = $(this).val();
    $(this).val(value.replace(/[^\d+(\.\d+)?$]/g,''));
});

$(document).on("paste", "input[data-positive-float-required='true']", function(){
