...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Research.is_credit_scheme'
        db.add_column(u'scientist_research', 'is_credit_scheme',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Research.total_credit'
        db.alter_column(u'scientist_research', 'total_credit', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Research.is_credit_scheme'
        db.delete_column(u'scientist_research', 'is_credit_scheme')


        # Changing field 'Research.total_credit'
        db.alter_column(u'scientist_research', 'total_credit', self.gf('django.db.models.fields.FloatField')())
