...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ParticipantResearch.status'
        db.delete_column(u'scientist_participantresearch', 'status')

        # Adding field 'ParticipantResearch.confirmed'
        db.add_column(u'scientist_participantresearch', 'confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ParticipantResearch.award_credit'
        db.add_column(u'scientist_participantresearch', 'award_credit',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Research.total_credit'
        db.add_column(u'scientist_research', 'total_credit',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ParticipantResearch.status'
        raise RuntimeError("Cannot reverse this migration. 'ParticipantResearch.status' and its values cannot be restored.")
        # Deleting field 'ParticipantResearch.confirmed'
        db.delete_column(u'scientist_participantresearch', 'confirmed')

        # Deleting field 'ParticipantResearch.award_credit'
        db.delete_column(u'scientist_participantresearch', 'award_credit')

        # Deleting field 'Research.total_credit'
        db.delete_column(u'scientist_research', 'total_credit')
