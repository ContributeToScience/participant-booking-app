...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LocationInfo.address'
        db.alter_column(u'scientist_locationinfo', 'address', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'LocationInfo.lat'
        db.alter_column(u'scientist_locationinfo', 'lat', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'LocationInfo.lng'
        db.alter_column(u'scientist_locationinfo', 'lng', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'LocationInfo.address'
        db.alter_column(u'scientist_locationinfo', 'address', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'LocationInfo.lat'
        db.alter_column(u'scientist_locationinfo', 'lat', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'LocationInfo.lng'
        db.alter_column(u'scientist_locationinfo', 'lng', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
