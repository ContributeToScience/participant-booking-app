...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'scientist_locationinfo', (
            ...
            ('position_x', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('position_y', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'scientist', ['LocationInfo'])


        # Renaming column for 'Research.location' to match new field type.
        db.rename_column(u'scientist_research', 'location', 'location_id')
        # Changing field 'Research.location'
        db.alter_column(u'scientist_research', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scientist.LocationInfo'], null=True))
        # Adding index on 'Research', fields ['location']
        db.create_index(u'scientist_research', ['location_id'])


    def backwards(self, orm):
        # Removing index on 'Research', fields ['location']
        db.delete_index(u'scientist_research', ['location_id'])
        ...
        # Renaming column for 'Research.location' to match new field type.
        db.rename_column(u'scientist_research', 'location_id', 'location')
        # Changing field 'Research.location'
        db.alter_column(u'scientist_research', 'location', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        u'scientist.locationinfo': {
            ...
            'position_x': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'position_y': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'})
        },
