...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RemindScientistInfo.type'
        db.add_column(u'scientist_remindscientistinfo', 'type',
                      self.gf('django.db.models.fields.CharField')(default='Email', max_length=20),
                      keep_default=False)

        # Adding field 'RemindParticipantInfo.type'
        db.add_column(u'scientist_remindparticipantinfo', 'type',
                      self.gf('django.db.models.fields.CharField')(default='Email', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RemindScientistInfo.type'
        db.delete_column(u'scientist_remindscientistinfo', 'type')

        # Deleting field 'RemindParticipantInfo.type'
        db.delete_column(u'scientist_remindparticipantinfo', 'type')
