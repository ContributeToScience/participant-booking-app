...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResearchEvent.is_participant_sent'
        db.add_column(u'scientist_researchevent', 'is_participant_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ResearchEvent.is_scientist_sent'
        db.add_column(u'scientist_researchevent', 'is_scientist_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResearchEvent.is_participant_sent'
        db.delete_column(u'scientist_researchevent', 'is_participant_sent')

        # Deleting field 'ResearchEvent.is_scientist_sent'
        db.delete_column(u'scientist_researchevent', 'is_scientist_sent')
