...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RemindScientistInfo.hours'
        db.delete_column(u'scientist_remindscientistinfo', 'hours')

        # Deleting field 'RemindScientistInfo.minutes'
        db.delete_column(u'scientist_remindscientistinfo', 'minutes')

        # Deleting field 'RemindScientistInfo.days'
        db.delete_column(u'scientist_remindscientistinfo', 'days')

        # Adding field 'RemindScientistInfo.research'
        db.add_column(u'scientist_remindscientistinfo', 'research',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['scientist.Research']),
                      keep_default=False)

        # Adding field 'RemindScientistInfo.time'
        db.add_column(u'scientist_remindscientistinfo', 'time',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'RemindScientistInfo.time_type'
        db.add_column(u'scientist_remindscientistinfo', 'time_type',
                      self.gf('django.db.models.fields.CharField')(default='minutes', max_length=20),
                      keep_default=False)

        # Deleting field 'RemindParticipantInfo.hours'
        db.delete_column(u'scientist_remindparticipantinfo', 'hours')

        # Deleting field 'RemindParticipantInfo.minutes'
        db.delete_column(u'scientist_remindparticipantinfo', 'minutes')

        # Deleting field 'RemindParticipantInfo.days'
        db.delete_column(u'scientist_remindparticipantinfo', 'days')

        # Adding field 'RemindParticipantInfo.research'
        db.add_column(u'scientist_remindparticipantinfo', 'research',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['scientist.Research']),
                      keep_default=False)

        # Adding field 'RemindParticipantInfo.time'
        db.add_column(u'scientist_remindparticipantinfo', 'time',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'RemindParticipantInfo.time_type'
        db.add_column(u'scientist_remindparticipantinfo', 'time_type',
                      self.gf('django.db.models.fields.CharField')(default='minutes', max_length=20),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding field 'RemindScientistInfo.hours'
        db.add_column(u'scientist_remindscientistinfo', 'hours',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RemindScientistInfo.minutes'
        db.add_column(u'scientist_remindscientistinfo', 'minutes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RemindScientistInfo.days'
        db.add_column(u'scientist_remindscientistinfo', 'days',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'RemindScientistInfo.research'
        db.delete_column(u'scientist_remindscientistinfo', 'research_id')

        # Deleting field 'RemindScientistInfo.time'
        db.delete_column(u'scientist_remindscientistinfo', 'time')

        # Deleting field 'RemindScientistInfo.time_type'
        db.delete_column(u'scientist_remindscientistinfo', 'time_type')

        # Adding field 'RemindParticipantInfo.hours'
        db.add_column(u'scientist_remindparticipantinfo', 'hours',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RemindParticipantInfo.minutes'
        db.add_column(u'scientist_remindparticipantinfo', 'minutes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RemindParticipantInfo.days'
        db.add_column(u'scientist_remindparticipantinfo', 'days',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'RemindParticipantInfo.research'
        db.delete_column(u'scientist_remindparticipantinfo', 'research_id')

        # Deleting field 'RemindParticipantInfo.time'
        db.delete_column(u'scientist_remindparticipantinfo', 'time')

        # Deleting field 'RemindParticipantInfo.time_type'
        db.delete_column(u'scientist_remindparticipantinfo', 'time_type')
