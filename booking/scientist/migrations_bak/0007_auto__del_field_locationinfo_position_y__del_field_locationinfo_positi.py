...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LocationInfo.position_y'
        db.delete_column(u'scientist_locationinfo', 'position_y')

        # Deleting field 'LocationInfo.position_x'
        db.delete_column(u'scientist_locationinfo', 'position_x')

        # Adding field 'LocationInfo.lng'
        db.add_column(u'scientist_locationinfo', 'lng',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LocationInfo.lat'
        db.add_column(u'scientist_locationinfo', 'lat',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LocationInfo.position_y'
        db.add_column(u'scientist_locationinfo', 'position_y',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LocationInfo.position_x'
        db.add_column(u'scientist_locationinfo', 'position_x',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'LocationInfo.lng'
        db.delete_column(u'scientist_locationinfo', 'lng')

        # Deleting field 'LocationInfo.lat'
        db.delete_column(u'scientist_locationinfo', 'lat')
    ...
    models = {
        ...
        u'scientist.locationinfo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lat': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'lng': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
