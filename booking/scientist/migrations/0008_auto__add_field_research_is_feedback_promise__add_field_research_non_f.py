...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Research.is_feedback_promise'
        db.add_column(u'scientist_research', 'is_feedback_promise',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Research.non_feedback_reason'
        db.add_column(u'scientist_research', 'non_feedback_reason',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Research.is_feedback_promise'
        db.delete_column(u'scientist_research', 'is_feedback_promise')

        # Deleting field 'Research.non_feedback_reason'
        db.delete_column(u'scientist_research', 'non_feedback_reason')
