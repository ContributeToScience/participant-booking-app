...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DonateSetting'
        db.create_table(u'scientist_donatesetting', (
        ...
        db.send_create_signal(u'scientist', ['DonateSetting'])


    def backwards(self, orm):
        # Deleting model 'DonateSetting'
        db.delete_table(u'scientist_donatesetting')
    ...
    models = {
        ...
        u'scientist.donatesetting': {
            'Meta': {'object_name': 'DonateSetting'},
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
