...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Research.payment_dt'
        db.add_column(u'scientist_research', 'payment_dt',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Research.payment_dt'
        db.delete_column(u'scientist_research', 'payment_dt')
