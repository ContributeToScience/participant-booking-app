...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DonateRecord'
        db.create_table(u'scientist_donaterecord', (
        ...
        db.send_create_signal(u'scientist', ['DonateRecord'])


    def backwards(self, orm):
        # Deleting model 'DonateRecord'
        db.delete_table(u'scientist_donaterecord')
