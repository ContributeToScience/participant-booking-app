...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ScientistPaymentRecord'
        db.create_table(u'scientist_scientistpaymentrecord', (
            ...
            ('credit', self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True)),
        ))
        db.send_create_signal(u'scientist', ['ScientistPaymentRecord'])


    def backwards(self, orm):
        # Deleting model 'ScientistPaymentRecord'
        db.delete_table(u'scientist_scientistpaymentrecord')
