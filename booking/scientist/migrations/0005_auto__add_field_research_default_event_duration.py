...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Research.default_event_duration'
        db.add_column(u'scientist_research', 'default_event_duration',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=45, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Research.default_event_duration'
        db.delete_column(u'scientist_research', 'default_event_duration')
