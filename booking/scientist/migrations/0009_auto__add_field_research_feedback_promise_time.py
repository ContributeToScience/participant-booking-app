...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Research.feedback_promise_time'
        db.add_column(u'scientist_research', 'feedback_promise_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Research.feedback_promise_time'
        db.delete_column(u'scientist_research', 'feedback_promise_time')
