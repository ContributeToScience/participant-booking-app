...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParticipantResearch.donate_credit'
        db.add_column(u'scientist_participantresearch', 'donate_credit',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParticipantResearch.donate_credit'
        db.delete_column(u'scientist_participantresearch', 'donate_credit')
