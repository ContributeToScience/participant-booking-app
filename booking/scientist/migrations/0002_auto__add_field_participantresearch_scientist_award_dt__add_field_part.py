...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParticipantResearch.scientist_award_dt'
        db.add_column(u'scientist_participantresearch', 'scientist_award_dt',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ParticipantResearch.participant_resp'
        db.add_column(u'scientist_participantresearch', 'participant_resp',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ParticipantResearch.participant_resp_dt'
        db.add_column(u'scientist_participantresearch', 'participant_resp_dt',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ParticipantResearch.superuser_award_dt'
        db.add_column(u'scientist_participantresearch', 'superuser_award_dt',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ParticipantResearch.payment_type'
        db.add_column(u'scientist_participantresearch', 'payment_type',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ParticipantResearch.payment_status'
        db.add_column(u'scientist_participantresearch', 'payment_status',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ParticipantResearch.payment_resp'
        db.add_column(u'scientist_participantresearch', 'payment_resp',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ParticipantResearch.payment_account'
        db.add_column(u'scientist_participantresearch', 'payment_account',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Research.payment_type'
        db.add_column(u'scientist_research', 'payment_type',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Research.is_paid'
        db.add_column(u'scientist_research', 'is_paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParticipantResearch.scientist_award_dt'
        db.delete_column(u'scientist_participantresearch', 'scientist_award_dt')

        # Deleting field 'ParticipantResearch.participant_resp'
        db.delete_column(u'scientist_participantresearch', 'participant_resp')

        # Deleting field 'ParticipantResearch.participant_resp_dt'
        db.delete_column(u'scientist_participantresearch', 'participant_resp_dt')

        # Deleting field 'ParticipantResearch.superuser_award_dt'
        db.delete_column(u'scientist_participantresearch', 'superuser_award_dt')

        # Deleting field 'ParticipantResearch.payment_type'
        db.delete_column(u'scientist_participantresearch', 'payment_type')

        # Deleting field 'ParticipantResearch.payment_status'
        db.delete_column(u'scientist_participantresearch', 'payment_status')

        # Deleting field 'ParticipantResearch.payment_resp'
        db.delete_column(u'scientist_participantresearch', 'payment_resp')

        # Deleting field 'ParticipantResearch.payment_account'
        db.delete_column(u'scientist_participantresearch', 'payment_account')

        # Deleting field 'Research.payment_type'
        db.delete_column(u'scientist_research', 'payment_type')

        # Deleting field 'Research.is_paid'
        db.delete_column(u'scientist_research', 'is_paid')
