...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AnonymousDonateRecord'
        db.create_table(u'scientist_anonymousdonaterecord', (
            ...
            ('donate_amount', self.gf('django.db.models.fields.FloatField')(default=0)),
        ))
        db.send_create_signal(u'scientist', ['AnonymousDonateRecord'])


    def backwards(self, orm):
        # Deleting model 'AnonymousDonateRecord'
        db.delete_table(u'scientist_anonymousdonaterecord')
    ...
    models = {
        ...
        u'scientist.anonymousdonaterecord': {
            'Meta': {'object_name': 'AnonymousDonateRecord'},
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'donate_amount': ('django.db.models.fields.FloatField', [], {'default': '0'}),
        ...
        u'scientist.donaterecord': {
            'Meta': {'object_name': 'DonateRecord'},
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'donate_amount': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
